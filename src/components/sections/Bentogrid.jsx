...
const Bentogrid = () => {
    ...
    const div2 = <div className="relative w-full h-full flex flex-col-reverse justify-center items-start gap-y-5 px-9">
                    <div className="absolute bottom-4 left-77 w-full text-8xl opacity-25 text-cyan-700"><FaDatabase /></div>
    ...
    return(
        <>
            <section className="flex flex-col md:grid md:grid-cols-2 md:grid-rows-2 gap-4 px-5 md:px-78 py-9 md:py-18 bg-white">
                ...
                <Bentogridcard bgColor={"bg-[#e8faff]"} ChildDiv={div2}/>
