...
const Normalgrid = () => {
    ...
    return(
        ...
        <section className="flex flex-col items-center px-5 md:px-78 py-9 md:py-18">
            <h2 className="px-2 md:px-35 py-11 text-2xl font-bold leading-[130%] tracking-tight uppercase text-center">Highest paying cities for Front Desk Agents<span className="text-blue-900"> near Me</span></h2>
